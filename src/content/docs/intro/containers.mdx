...
By default, algorithms in opendatakit run in the python-run-base Docker
...
FROM open-datakit/python-run-base:latest
...
This tells opendatakit to use `mycontainer` when executing the `helloworld`
algorithm.
