...
By convention, we put any input data files under a directory named `data` at the root of the datapackage. Create the `data` directory, open `data/tabulardata.csv` and paste the following table:
