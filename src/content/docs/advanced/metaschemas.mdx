...
[helloworld-datakit](https://github.com/open-datakit/helloworld-datakit)
repository, under the
["tabulardata" algorithm folder](https://github.com/open-datakit/helloworld-datakit/tree/main/tabulardata).
...
```json title="tabulardata/algorithm.json" ins={16-18,22}
{
  ...
  "code": "algorithm.py",
  "container": "open-datakit/python-run-base:latest",
  "signature": {
    "inputs": [
      {
        "name": "data",
